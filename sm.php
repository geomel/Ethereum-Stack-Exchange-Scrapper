...
$page_title = "Source Code Metrics";
...
$page_nav["graphs"]["sub"]["sm"]["active"] = true;
	...
	<div id="content">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
				<h1 class="page-title txt-color-blueDark"><img src="img/network.png" width="40" height="30">&nbsp;&nbsp;Source Code Metrics</h1>
			</div>
...
<script type="text/javascript">
 ...
 function php2Js(){
	<?php
			...
			foreach($_SESSION['lcom'] as $key=>$value){
				echo "lcom[".$key."]=".$value.";";
			}
			foreach($_SESSION['nom'] as $key=>$value){
				echo "nom[".$key."]=".$value.";";
			}
			foreach($_SESSION['nof'] as $key=>$value){
				echo "nof[".$key."]=".$value.";";
			}
			...
			var options = {
				...
				switch(flag) {
						case "1":
							...
							break;
						case "2":
							var edges_plot = $.plot($("#lcomchart"), [tableData], options);
							break;
						case "3":
							var diameter_plot = $.plot($("#nomchart"), [tableData], options);
							break;	
						case "4":
							var cc_plot = $.plot($("#nofchart"), [tableData], options);
							break;
						case "5":
